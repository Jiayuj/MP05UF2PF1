...
public class HashTable {
    ...
    public void put(String key, String value) {
        ...
        if(entries[hash] == null) {
            ...
            //compara primera si es misma cambia volo y salir.
            if (temp.key.equals(key)) {
                temp.value = value;
            } else {
                //si no es misma y siguede no hay valor añade a final.
                while (temp.next != null) {
                    temp = temp.next;
                    //error esta aqui , que no compara es mismo key.
                    if (temp.key.equals(key)) {
                        temp.value = value;
                        hashEntry.key = null;
                    }
                }
                //otro error es se añadir si o si la nueva valor a final, hay que poner un if para si han reprazado valor no añader nueva valor.
